...
<img src="images/proxytest_crash.jpg" width="200">

If you are experiencing this problem - update ByeByeDPI to a version >1.5.2.
...
## <a id="error-parsing-the-package">Ошибка при синтаксическом анализе пакета</a>
