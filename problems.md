...
24. [Не удалось запустить VPN](#unable-to-start)
25. [Не работает на sbertv / saluttv](#sber)
...
Попробуйте добавить приложение Home или какое-то другое приложение, которое отвечает за **начальный экран** в _[белый список](features.md#белый-и-чёрный-списки)_.
...
## <a id="unable-to-start">24. Не удалось запустить VPN</a>
...
## <a id="sber">25. Не работает на sbertv / saluttv</a>
...
Если проблема сохраняется - есть вероятность, что необходима специальная [настройка](https://github.com/BDManual/ByeByeDPI-Manual/blob/main/sbox.md) телевизора.
