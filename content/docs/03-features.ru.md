...
Данный переключатель заставляет ByeByeDPI искать только IPv6 адреса (если вы собираетесь включать его, то убедитесь, что ваш оператор поддерживает IPv6 и сайты нужные вам имеют IPv6 адрес).
