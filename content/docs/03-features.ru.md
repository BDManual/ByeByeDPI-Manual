...
После выдачи прав можно указывать путь к файлу у аргументов, поддерживающих передачу файла (можете ознакомится с этим в [документации ByeDPI](https://github.com/hurfea/byedpi)).
