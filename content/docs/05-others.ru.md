...
- [YouTube for Android TV](https://play.google.com/store/apps/details?id=com.google.android.youtube.tv) - официальное приложение YouTube для управления пультом. Требуется Android 7.0+
...
- [NouTube](https://github.com/nonbili/NouTube) - YouTube и YouTube Music в одном приложении. Без рекламы, играет в фоновом режиме.
- [pstube](https://github.com/prateekmedia/pstube) - смотрите и скачивайте видео без рекламы
...
> [!TIP]
> Можно использовать [пакет ByeDPI](https://github.com/DPITrickster/ByeDPI-OpenWrt) в качестве outbound'a в [podkop](https://github.com/itdoginfo/podkop), чтобы управлять трафиком через sing-box. Гайд можно прочитать [здесь](https://github.com/DPITrickster/Podkop-ByeDPI-OpenWRT)
...
Появилась собранная версия от Kiric81, найти её можно тут: [ссылка](https://github.com/Kiric81/Rumble/actions). Вам необходимо перейти по наиболее свежей сборке и скачать артефакт (Artifacts) в формате `.zip`. Внутри скачанного архива и будет расположен файл .ipa, который можно установить в iOS.
